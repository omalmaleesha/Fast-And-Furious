    ...
    <main className="relative bg-black text-white overflow-hidden">
      ...
      <section ref={heroRef} className="relative pb-10 pt-10 flex items-center justify-center overflow-hidden" style={{ transformStyle: 'preserve-3d' }}>
        ...
        <motion.div
          ...
          style={{ opacity: heroOpacity * 0.2, y: heroY * 0.2, z: -50 }}
        >
        ...
        <div className="container relative z-10 px-4 mx-auto text-center" style={{ transform: 'translateZ(50px)' }}>
          ...
          >
            ...
            <motion.h2
              className="absolute bottom-5 left-1/2 -translate-x-1/2 text-xl md:text-3xl font-bold text-[#ff6b00] font-['Anton',_sans-serif] text-center pointer-events-none"
      ...
      <TextZoomReveal className="mt-0" />

      {/* Scroll-Controlled Video Section */}
      <ScrollVideo className="mb-0" />
